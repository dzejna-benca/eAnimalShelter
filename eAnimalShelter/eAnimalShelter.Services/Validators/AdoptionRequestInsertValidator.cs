...
{
    public class AdoptionRequestInsertValidator
        : AbstractValidator<AdoptionRequestInsertRequest>
    {
        public AdoptionRequestInsertValidator()
        {
            RuleFor(x => x.AnimalId)
                .GreaterThan(0)
                .WithMessage("AnimalId must be greater than 0.");
