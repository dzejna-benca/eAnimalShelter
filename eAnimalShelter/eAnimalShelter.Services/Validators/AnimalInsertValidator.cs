...
{
    public class AnimalInsertValidator
        : AbstractValidator<AnimalInsertRequest>
    {
        public AnimalInsertValidator()
        {
            RuleFor(x => x.Name)
                .NotEmpty()
                .WithMessage("Animal name is required and can contain up to 100 characters.")
                .MaximumLength(100)
