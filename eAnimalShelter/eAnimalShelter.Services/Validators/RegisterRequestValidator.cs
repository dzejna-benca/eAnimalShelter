    ...
    public class RegisterRequestValidator : AbstractValidator<RegisterRequest>
    {
        public RegisterRequestValidator()
        {
            ...
            RuleFor(x => x.Username)
                ...
                .MaximumLength(30)
                .WithMessage("Username can contain a maximum of 30 characters.");
            ...
            RuleFor(x => x.Role)
                .Must(r =>
                    r == UserRoleType.Client ||
                    r == UserRoleType.Volunteer)
                .WithMessage("Only Client and Volunteer roles are allowed.");
